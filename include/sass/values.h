...
ADDAPI struct SassValue* ADDCALL sass_make_list    (enum Sass_Separator sep, bool is_bracketed);
...
ADDAPI struct SassValue* ADDCALL sass_value_op (enum Sass_OP op, struct SassValue* a, struct SassValue* b);
...
ADDAPI enum Sass_Tag ADDCALL sass_value_get_tag (struct SassValue* v);
...
ADDAPI size_t ADDCALL sass_list_get_length(struct SassValue* list);
...
ADDAPI enum Sass_Separator ADDCALL sass_list_get_separator (struct SassValue* v);
ADDAPI void ADDCALL sass_list_set_separator (struct SassValue* v, enum Sass_Separator value);
...
// ADDAPI size_t ADDCALL sass_map_get_length (struct SassValue* v);
