...
namespace Sass {
  ...
  template<
    ...
    class ListAllocator = SassAllocator<std::pair<TKey, TVal>>,
    class MapAllocator = SassAllocator<std::pair<const TKey, size_t>>
  >
  class ordered_map {
    ...
    public:
      ...
      // The copy contructor for rule of three
      ...
      // The move contructor for rule of three
      ...
      /////////////////////////////////////////////////////////////////////////////
      // Implement mixed manupulation API
      /////////////////////////////////////////////////////////////////////////////
