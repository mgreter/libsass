...
namespace Sass {
  ...
  public:
    ...
    SimpleSequence_Selector_Ptr new_SimpleSequence_Selector(std::string p, size_t l, size_t s = 0);
    Sequence_Selector_Ptr new_Sequence_Selector(std::string p, size_t l, Sequence_Selector_Ref::Combinator c, Sequence_Selector_Ptr ctx, SimpleSequence_Selector_Ptr sel);
    CommaSequence_Selector_Ptr new_CommaSequence_Selector(std::string p, size_t l, size_t s = 0);
  };
}
