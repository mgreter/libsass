...
namespace Sass {
  ...
  Mixin_Call::Mixin_Call(ParserState pstate, std::string n, Arguments_Obj args, Block_Obj b)
  ...
  Content::Content(ParserState pstate)
  : Statement(pstate),
    media_block_(NULL)
