    ...
    namespace Strings {
      ...
      BUILT_IN_FN(insert)
      {
        ...
        long index = arguments[2]->assertNumber(logger642, "index")
          ...
          ->assertInt(logger642, pstate, "index");
      ...
      BUILT_IN_FN(slice)
      {
        ...
        size_t len = Unicode::codePointCount(string->value());
        beg = beg->assertNoUnits(logger642, pstate, "start");
        end = end->assertNoUnits(logger642, pstate, "end");
        ...
        long begInt = beg->assertNoUnits(logger642, pstate, "start")
          ->assertInt(logger642, pstate);
