...
name(Env& env, Env& d_env, Context& ctx, Signature sig, ParserState pstate, Backtrace* backtrace, std::vector<CommaComplex_Selector_Obj> selector_stack)

namespace Sass {
  struct Backtrace;
  typedef Environment<AST_Node_Obj> Env;
  typedef Environment<AST_Node_Ptr> Env2;
