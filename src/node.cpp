...
namespace Sass {
  ...
  Node Node::createCombinator(const Complex_Selector_Ref::Combinator& combinator) {
    NodeDequePtr null;
  ...
  Node Node::createSelector(Complex_Selector_Ptr pSelector, Context& ctx) {
    ...
    Node n(SELECTOR, Complex_Selector_Ref::ANCESTOR_OF, pStripped, null /*pCollection*/);
  ...
  Node Node::createCollection() {
    ...
    return Node(COLLECTION, Complex_Selector_Ref::ANCESTOR_OF, NULL /*pSelector*/, pEmptyCollection);
  }


  Node Node::createCollection(const NodeDeque& values) {
    NodeDequePtr pShallowCopiedCollection = std::make_shared<NodeDeque>(values);
    return Node(COLLECTION, Complex_Selector_Ref::ANCESTOR_OF, NULL /*pSelector*/, pShallowCopiedCollection);
  }


  Node Node::createNil() {
    NodeDequePtr null;
    return Node(NIL, Complex_Selector_Ref::ANCESTOR_OF, NULL /*pSelector*/, null /*pCollection*/);
  }


  Node::Node(const TYPE& type, Complex_Selector_Ref::Combinator combinator, Complex_Selector_Ptr pSelector, NodeDequePtr& pCollection)
  ...
  Node complexSelectorToNode(Complex_Selector_Ptr pToConvert, Context& ctx) {
    ...
    while (pToConvert) {
      ...
      if (pToConvert->combinator() != Complex_Selector_Ref::ANCESTOR_OF) {
  ...
  // This is only used in Complex_Selector_Ref::unify_with for now, may need modifications to fit other needs
