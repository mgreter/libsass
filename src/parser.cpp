...
namespace Sass {
  ...
  CommaSequence_Selector_Obj Parser::parse_selector_list(bool in_root)
  {
    bool reloop = true;
  ...
  Sequence_Selector_Obj Parser::parse_complex_selector(bool in_root)
  {
  ...
  SimpleSequence_Selector_Obj Parser::parse_compound_selector()
  {
