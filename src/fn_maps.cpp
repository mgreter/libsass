  ...
  namespace Functions {
    ...
    namespace Maps {
      ...
      BUILT_IN_FN(get)
      {
        ...
        Value* key = arguments[1]->assertValue(*ctx.logger123, Sass::Strings::key);
      ...
      BUILT_IN_FN(merge)
      {
        MapObj map1 = arguments[0]->assertMap(*ctx.logger123, Sass::Strings::map1);
      ...
      {
        return arguments[0]->assertMap(*ctx.logger123, Sass::Strings::map);
      }
