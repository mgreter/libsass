...
namespace Sass {
  ...
  public:
    Trace_Ref(ParserState pstate, std::string n, Block_Ptr b = 0)
  ...
  class Keyframe_Rule_Ref : public Has_Block_Ref {
    ADD_PROPERTY(Selector_Ptr, selector)
  public:
    Keyframe_Rule_Ref(ParserState pstate, Block_Ptr b)
    : Has_Block_Ref(pstate, b), selector_(0)
  ...
  public:
    If_Ref(ParserState pstate, Expression_Ptr pred, Block_Ptr con, Block_Ptr alt = 0)
  ...
  public:
    Each_Ref(ParserState pstate, std::vector<std::string> vars, Expression_Ptr lst, Block_Ptr b)
  ...
  public:
    Mixin_Call_Ref(ParserState pstate, std::string n, Arguments_Ptr args, Block_Ptr b = 0)
  ...
  class Media_Query_Ref : public Expression_Ref,
    ...
    ADD_PROPERTY(String_Ptr, media_type)
  ...
  using AST_Node_Obj = Memory_Node<AST_Node>;
  using Statement_Obj = Memory_Node<Statement>;
  using Block_Obj = Memory_Node<Block>;
  using Ruleset_Obj = Memory_Node<Ruleset>;
  using Bubble_Obj = Memory_Node<Bubble>;
  using Trace_Obj = Memory_Node<Trace>;
  using Media_Block_Obj = Memory_Node<Media_Block>;
  using Supports_Block_Obj = Memory_Node<Supports_Block>;
  using Directive_Obj = Memory_Node<Directive>;
  using Keyframe_Rule_Obj = Memory_Node<Keyframe_Rule>;
  using At_Root_Block_Obj = Memory_Node<At_Root_Block>;
  using Declaration_Obj = Memory_Node<Declaration>;
  using Assignment_Obj = Memory_Node<Assignment>;
  using Import_Obj = Memory_Node<Import>;
  using Import_Stub_Obj = Memory_Node<Import_Stub>;
  using Warning_Obj = Memory_Node<Warning>;
  using Error_Obj = Memory_Node<Error>;
  using Debug_Obj = Memory_Node<Debug>;
  using Comment_Obj = Memory_Node<Comment>;
  using PreValue_Obj = Memory_Node<PreValue>;
  using Has_Block_Obj = Memory_Node<Has_Block>;
  using Thunk_Obj = Memory_Node<Thunk>;
  using If_Obj = Memory_Node<If>;
  using For_Obj = Memory_Node<For>;
  using Each_Obj = Memory_Node<Each>;
  using While_Obj = Memory_Node<While>;
  using Return_Obj = Memory_Node<Return>;
  using Content_Obj = Memory_Node<Content>;
  using Extension_Obj = Memory_Node<Extension>;
  using Definition_Obj = Memory_Node<Definition>;
  using Mixin_Call_Obj = Memory_Node<Mixin_Call>;
  using Value_Obj = Memory_Node<Value>;
  using Expression_Obj = Memory_Node<Expression>;
  using List_Obj = Memory_Node<List>;
  using Map_Obj = Memory_Node<Map>;
  using Binary_Expression_Obj = Memory_Node<Binary_Expression>;
  using Unary_Expression_Obj = Memory_Node<Unary_Expression>;
  using Function_Call_Obj = Memory_Node<Function_Call>;
  using Function_Call_Schema_Obj = Memory_Node<Function_Call_Schema>;
  using Custom_Warning_Obj = Memory_Node<Custom_Warning>;
  using Custom_Error_Obj = Memory_Node<Custom_Error>;
  using Variable_Obj = Memory_Node<Variable>;
  using Textual_Obj = Memory_Node<Textual>;
  using Number_Obj = Memory_Node<Number>;
  using Color_Obj = Memory_Node<Color>;
  using Boolean_Obj = Memory_Node<Boolean>;
  using String_Schema_Obj = Memory_Node<String_Schema>;
  using String_Obj = Memory_Node<String>;
  using String_Constant_Obj = Memory_Node<String_Constant>;
  using String_Quoted_Obj = Memory_Node<String_Quoted>;
  using Media_Query_Obj = Memory_Node<Media_Query>;
  using Media_Query_Expression_Obj = Memory_Node<Media_Query_Expression>;
  using Supports_Condition_Obj = Memory_Node<Supports_Condition>;
  using Supports_Operator_Obj = Memory_Node<Supports_Operator>;
  using Supports_Negation_Obj = Memory_Node<Supports_Negation>;
  using Supports_Declaration_Obj = Memory_Node<Supports_Declaration>;
  using Supports_Interpolation_Obj = Memory_Node<Supports_Interpolation>;
  using At_Root_Query_Obj = Memory_Node<At_Root_Query>;
  using Null_Obj = Memory_Node<Null>;
  using Parent_Selector_Obj = Memory_Node<Parent_Selector>;
  using Parameter_Obj = Memory_Node<Parameter>;
  using Parameters_Obj = Memory_Node<Parameters>;
  using Argument_Obj = Memory_Node<Argument>;
  using Arguments_Obj = Memory_Node<Arguments>;
  using Selector_Obj = Memory_Node<Selector>;
  using Selector_Schema_Obj = Memory_Node<Selector_Schema>;
  using Placeholder_Selector_Obj = Memory_Node<Placeholder_Selector>;
  using Element_Selector_Obj = Memory_Node<Element_Selector>;
  using Class_Selector_Obj = Memory_Node<Class_Selector>;
  using Id_Selector_Obj = Memory_Node<Id_Selector>;
  using Attribute_Selector_Obj = Memory_Node<Attribute_Selector>;
  using Pseudo_Selector_Obj = Memory_Node<Pseudo_Selector>;
  using Wrapped_Selector_Obj = Memory_Node<Wrapped_Selector>;
  using SimpleSequence_Selector_Obj = Memory_Node<SimpleSequence_Selector>;
  using Sequence_Selector_Obj = Memory_Node<Sequence_Selector>;
  using CommaSequence_Selector_Obj = Memory_Node<CommaSequence_Selector>;
