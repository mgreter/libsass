...
namespace Sass {
  ...
  public:
    ...
    static SelectorList_Obj parse_selector2(const char* src, Context& ctx, Backtraces, ParserState pstate = ParserState("[SELECTOR]"), const char* source = nullptr, bool allow_parent = true);
